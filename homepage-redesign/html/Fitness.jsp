    ...
    <div class="row">
        <div class="col-xs-12 interactive-carousel-container">
            <interactive-carousel id="fitness">
                <section-header desktop-header-image="//img1.beachbodyimages.com/beachbody/image/upload/bbweb/homepage/heading_fitness.png"
                                tablet-header-image="//img1.beachbodyimages.com/beachbody/image/upload/bbweb/homepage/t_heading_fitness.png"
                                mobile-header-image="//img1.beachbodyimages.com/beachbody/image/upload/bbweb/homepage/m_heading_fitness.png"
